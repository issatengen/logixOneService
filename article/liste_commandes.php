      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="col-md-7">
              ...
              <form action="liste_commandes.php" method="post" style="margin-top:10px">
                  <div class="row">
                      <div class="col-md-4">
          ...
          <div class="row">
            ...
            <div class="col-sm-4 mb-2">
              <a href="form_ajout_commande.php">
                <button class="btn btn-success">
                  <i class="bi bi-plus"></i>
                  <b><?= ajouter ?></b>
                </button>
              </a>
              <a href="csv_liste_commandes.php">
                <button class="btn btn-success">
              ...
              <table class="table datatable">
                ...
                <tr>
                  ...
                  <td>
                    <button 
                      onclick="
                      let del=confirm('Voulez-vous vraiment supprimer cette commande ?');
                      if(del==true){
