...
<head>
  ...
  <title>LogixOne / Add category</title>
            ...
            <form class="row g-3 needs-validation" action="ajout_categorie.php" method="post" novalidate>
                ...
                <div class="col-md-6">
                  ...
                  <div class="input-group has-validation">
                    <input type="text" class="form-control" id="validationCustomUsername" aria-describedby="inputGroupPrepend" name="description_categorie" required>
                    <div class="invalid-feedback">
                      <?= veillez_entre_description_categorie ?>
                    </div>
                  </div>
                </div>
                <div class="col-12">
