...
?>
  <main class="main" id="main">
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="liste_roles.php">Liste des roles</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
            <br>
            <form action="ajout_role.php" method="post"  >
              <hr>
              <div class="row col-md-4">
                <label for="identifiant"><b>Code</b></label><br>
                <input type="text" class="form-control" name="code_role"><br>
              </div>
