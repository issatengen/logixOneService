            ...
            <div class="card-body">
              ...
              <table class="table datatable">
                ...
                <tr>
                  ...
                  <td>
                    <button class="btn btn-danger" data-bs-toggle="tooltip" data-bs-placement="right" title="<?= supprimer ?>"
                      onclick="
                        if(confirm('Voulez-vous vraiment supprimer cette commande ?')==true){
                          window.location.replace('supprimer_commande.php?id_commande=<?= $liste_commande['id_commande']?>');
                        }else{
                          exit;
                        }
                      ">
                    ...
                    <a href="form_modifier_commande.php?id_commande=<?= $liste_commande['id_commande']?>" >
                      <button class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="left" title="<?= modifier ?>">
                  ...
                  <td>
                    <a href="#">
                      <button class="btn btn-outline-secondary rounded-circle" data-bs-toggle="tooltip" data-bs-placement="right" title="Livré">
                ...
                ?>
                 <td>
                    <a href="#">
                      <button class="btn btn-info rounded-circle" data-bs-toggle="tooltip" data-bs-placement="right" title="Non livré" >
